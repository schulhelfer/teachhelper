...
const CHILD_TO_PARENT_EVENT = new Map([
  [GRADES_MANUAL_SAVE_STATE_EVENT, GRADES_MANUAL_SAVE_STATE_EVENT],
  [GRADES_UNSAVED_STATE_EVENT, GRADES_UNSAVED_STATE_EVENT],
  [GRADES_TAB_LEAVE_RESULT_EVENT, GRADES_TAB_LEAVE_RESULT_EVENT],
  [GRADES_VIEW_REQUEST_EVENT, GRADES_VIEW_REQUEST_EVENT],
  [GRADES_TUTORIAL_START_REQUEST_EVENT, GRADES_TUTORIAL_START_REQUEST_EVENT],
  ...
  [GRADES_COURSE_CONTEXT_EVENT, GRADES_COURSE_CONTEXT_EVENT],
  [GRADES_COURSE_SEATPLAN_SAVE_RESULT_EVENT, GRADES_COURSE_SEATPLAN_SAVE_RESULT_EVENT],
  [GRADES_COURSE_PICKER_CONFIG_SAVE_RESULT_EVENT, GRADES_COURSE_PICKER_CONFIG_SAVE_RESULT_EVENT],
  [GRADES_GRADE_ROSTER_COURSES_RESULT_EVENT, GRADES_GRADE_ROSTER_COURSES_RESULT_EVENT],
  [GRADES_GRADE_ROSTER_IMPORT_RESULT_EVENT, GRADES_GRADE_ROSTER_IMPORT_RESULT_EVENT],
  [GRADES_NAME_LEARNING_DATA_RESULT_EVENT, GRADES_NAME_LEARNING_DATA_RESULT_EVENT],
  [GRADES_NAME_LEARNING_REVIEW_RESULT_EVENT, GRADES_NAME_LEARNING_REVIEW_RESULT_EVENT],
  [GRADES_NAME_LEARNING_STUDENT_SEARCH_RESULT_EVENT, GRADES_NAME_LEARNING_STUDENT_SEARCH_RESULT_EVENT],
]);

function normalizeNavigation(detail = {}) {
  const source = detail && typeof detail === 'object' ? detail : {};
  const subview = source.action === 'seatplan'
    || source.subview === 'entry'
    || source.gradesSubview === 'entry'
    ? 'entry'
    : 'overview';
  return {
    ...source,
...
export function mountGrades({ host } = {}) {
  ...
  const frame = createModuleFrame({
    ...
    src: GRADES_URL,
    title: 'Noten',
    allow: WORKSPACE_CLIENT_MODULE_ALLOW,
  });
