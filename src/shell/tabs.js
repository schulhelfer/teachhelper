...
export const GRADES_COURSE_PICKER_CONFIG_SAVE_REQUEST_EVENT = 'classroom:grades-course-picker-config-save-request';
export const GRADES_COURSE_PICKER_CONFIG_SAVE_RESULT_EVENT = 'classroom:grades-course-picker-config-save-result';
...
export const GRADES_NAME_LEARNING_COURSE_VISIBILITY_REQUEST_EVENT = 'classroom:grades-name-learning-course-visibility-request';
export const GRADES_NAME_LEARNING_STUDENT_SEARCH_REQUEST_EVENT = 'classroom:grades-name-learning-student-search-request';
export const GRADES_NAME_LEARNING_STUDENT_SEARCH_RESULT_EVENT = 'classroom:grades-name-learning-student-search-result';
...
export const NAME_LEARNING_COURSE_VISIBILITY_REQUEST_EVENT = 'classroom:name-learning-course-visibility-request';
export const NAME_LEARNING_MANAGE_STUDENTS_REQUEST_EVENT = 'classroom:name-learning-manage-students-request';
export const NAME_LEARNING_STUDENT_SEARCH_REQUEST_EVENT = 'classroom:name-learning-student-search-request';
...
export const QR_CAMERA_REQUEST_EVENT = 'classroom:qr-camera-request';
export const QR_CAMERA_STATE_EVENT = 'classroom:qr-camera-state';
export const QR_CAMERA_RESULT_EVENT = 'classroom:qr-camera-result';
export const MODULE_OPEN_EXTERNAL_REQUEST_EVENT = 'classroom:module-open-external-request';
export const MODULE_CONTEXT_MENU_DISMISS_EVENT = 'classroom:module-context-menu-dismiss';
