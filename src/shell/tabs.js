...
export const PLANNING_GRADE_VAULT_OVERLAY_EVENT = 'classroom:planning-grade-vault-overlay';
...
export const PLANNING_GRADE_ROSTER_COURSES_REQUEST_EVENT = 'classroom:planning-grade-roster-courses-request';
export const PLANNING_GRADE_ROSTER_COURSES_RESULT_EVENT = 'classroom:planning-grade-roster-courses-result';
export const PLANNING_GRADE_ROSTER_IMPORT_REQUEST_EVENT = 'classroom:planning-grade-roster-import-request';
export const PLANNING_GRADE_ROSTER_IMPORT_RESULT_EVENT = 'classroom:planning-grade-roster-import-result';




export const GRADES_MANUAL_SAVE_STATE_EVENT = 'classroom:grades-manual-save-state';
export const GRADES_MANUAL_SAVE_REQUEST_EVENT = PLANNING_MANUAL_SAVE_REQUEST_EVENT;
...
export const GRADES_GRADE_VAULT_STATE_EVENT = PLANNING_GRADE_VAULT_STATE_EVENT;
export const GRADES_GRADE_VAULT_REQUEST_EVENT = PLANNING_GRADE_VAULT_REQUEST_EVENT;
export const GRADES_GRADE_VAULT_OVERLAY_EVENT = PLANNING_GRADE_VAULT_OVERLAY_EVENT;
export const GRADES_COURSE_GRADE_CONFIG_REQUEST_EVENT = PLANNING_COURSE_GRADE_CONFIG_REQUEST_EVENT;
export const GRADES_COURSE_GRADE_CONFIG_RESULT_EVENT = PLANNING_COURSE_GRADE_CONFIG_RESULT_EVENT;
export const GRADES_COURSE_GRADE_SAVE_REQUEST_EVENT = PLANNING_COURSE_GRADE_SAVE_REQUEST_EVENT;
export const GRADES_COURSE_GRADE_SAVE_RESULT_EVENT = PLANNING_COURSE_GRADE_SAVE_RESULT_EVENT;
export const GRADES_GRADE_ROSTER_COURSES_REQUEST_EVENT = PLANNING_GRADE_ROSTER_COURSES_REQUEST_EVENT;
export const GRADES_GRADE_ROSTER_COURSES_RESULT_EVENT = PLANNING_GRADE_ROSTER_COURSES_RESULT_EVENT;
export const GRADES_GRADE_ROSTER_IMPORT_REQUEST_EVENT = PLANNING_GRADE_ROSTER_IMPORT_REQUEST_EVENT;
export const GRADES_GRADE_ROSTER_IMPORT_RESULT_EVENT = PLANNING_GRADE_ROSTER_IMPORT_RESULT_EVENT;
...
export const GRADES_SHELL_LAYOUT_EVENT = PLANNING_SHELL_LAYOUT_EVENT;
