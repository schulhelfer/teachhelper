...
export const HELP_ARTICLES = [
  ...
  article('grades-protection', 'grades', 'Schutz sensibler Notendaten', 'Passwortschutz, Privatsphäre und Sicherung der Notendaten.', ['passwort', 'schutz', 'datenschutz', 'privacy', 'verschluesselung', 'backup'], [
    ...
    { title: 'Vor der automatischen Sperre speichern', text: 'Unter Verschlüsselung → Automatische Sperre kannst du das Speichern vor der Sperre einschalten. Die Option ist standardmäßig ausgeschaltet und benötigt eine direkte Verbindung zur Datenbankdatei. Gespeichert werden bereits übernommene Notenänderungen; offene Eingabeentwürfe werden nicht übernommen. Bei ungespeicherten Noten bleibt der Bereich offen, wenn die Option ausgeschaltet ist oder das Speichern scheitert.' },
