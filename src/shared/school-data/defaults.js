...
export const SHOW_HALF_YEAR_BOUNDARY_MARKERS_DEFAULT = true;
export const SHOW_GRADE_STUDENT_PORTRAITS_DEFAULT = false;
export const SHOW_NAME_LEARNING_MODULE_DEFAULT = false;
export const SHOW_HIDDEN_NAME_LEARNING_COURSES_DEFAULT = false;
