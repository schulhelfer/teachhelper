...
export const WORKSPACE_ERROR_VAULT_PLAINTEXT_SEGMENT = 'VAULT_PLAINTEXT_SEGMENT';
export const WORKSPACE_ERROR_PERSISTENCE_CONFLICT = 'PERSISTENCE_CONFLICT';
export const WORKSPACE_ERROR_PERSISTENCE_INCOMPLETE = 'PERSISTENCE_INCOMPLETE';
export const WORKSPACE_ERROR_PERSISTENCE_CONTENT_LOSS = 'PERSISTENCE_CONTENT_LOSS';
