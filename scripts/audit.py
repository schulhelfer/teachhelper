...
required_precache_assets = [
  ...
  ROOT / 'src' / 'app' / 'qr-camera-controller.js',
  ROOT / 'src' / 'app' / 'shell' / 'chrome-controller.js',
  ROOT / 'src' / 'app' / 'shell' / 'sidebar-resize.js',
  ROOT / 'src' / 'app' / 'shell' / 'tab-controller.js',
  ROOT / 'src' / 'app' / 'shell' / 'tab-nav-layout.js',
  ROOT / 'src' / 'app' / 'shell' / 'workspace-status.js',
  ...
  ROOT / 'src' / 'modules' / 'grades' / 'grade-calculations.js',
